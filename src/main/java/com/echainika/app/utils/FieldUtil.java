...
public final class FieldUtil {
    ...
    public static Map<String, FieldStrategy> COLUMN_STRATEGY_MAP = Map.ofEntries(
            ...
            Map.entry(CONTACT_NUMBER, new PhoneField(CONTACT_NUMBER, (cv, cr) -> cr.setContactNumber(cv))),
            Map.entry(POC, new GenericField(POC, (cv, cr) -> cr.setPoc(cv))),
            Map.entry(POC_CONTACT_NUMBER, new PhoneField(POC_CONTACT_NUMBER, (cv, cr) -> cr.setPocContactNumber(cv))),
